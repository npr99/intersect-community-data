    ...
    incore_v2_DataStructure = {
        ...
        {   'label' : 'Tenure Status',
            ...
            'notes' : '\n'.join([
                ...
                f'https://data.census.gov/cedsci/table?g=0500000US{state_county}&tid=DECENNIALSF12010.H16. \n \n'
                f'https://data.census.gov/cedsci/table?g=0500000US{state_county}&tid=DECENNIALDHC2020.H12. \n \n'
                    ]),
            'primary_key' : 'huid',
            'pop_var' : 'numprec'},
        'race' : 
        {   'label' : 'Race of Householder',
            ...
            'notes' : '\n'.join([
                ...
                f'https://data.census.gov/cedsci/table?g=0500000US{state_county}&tid=DECENNIALSF12010.H6. \n \n'
                f'https://data.census.gov/cedsci/table?g=0500000US{state_county}&tid=DECENNIALDHC2020.H6. \n \n'
                ]),
            'primary_key' : 'huid',
            'pop_var' : 'numprec'},
        'hispan' : 
        {   'label' : 'Hispanic Householder',
            ...
            'notes' : '\n'.join([
                ...
                f'https://data.census.gov/cedsci/table?g=0500000US{state_county}&tid=DECENNIALSF12010.H7. \n \n'
                f'https://data.census.gov/cedsci/table?g=0500000US{state_county}&tid=DECENNIALDHC2020.H7.'
                ]),
            'primary_key' : 'huid',
            'pop_var' : 'numprec'},
        'family' : 
        {   'label' : 'Family Household',
            ...
            'notes' : '\n'.join([
                ...
                f'https://data.census.gov/cedsci/table?g=0500000US{state_county}&tid=DECENNIALSF12010.P18. \n \n'
                f'https://data.census.gov/cedsci/table?g=0500000US{state_county}&tid=DECENNIALDHC2020.P16.'
                ]),
            'primary_key' : 'huid',
            'pop_var' : 'numprec'},
        'vacancy' : 
        {   'label' : 'Vacancy Type',
            ...
            'notes' : '\n'.join([
                ...
                '2. To verify results compare table to: \n \n'
                f'https://data.census.gov/cedsci/table?g=0500000US{state_county}&tid=DECENNIALSF12010.H5. \n \n'
                f'https://data.census.gov/cedsci/table?g=0500000US{state_county}&tid=DECENNIALDHC2020.H5.'
                ]),
            'primary_key' : 'huid',
            'pop_var' : 'numprec'},
        'gqtype' : 
        {   'label' : 'Group Quarters Type',
            ...
            'notes' : '\n'.join([
                ...
                f'https://data.census.gov/cedsci/table?g=0500000US{state_county}&tid=DECENNIALSF12010.P42.  \n \n'
                f'https://data.census.gov/cedsci/table?g=0500000US{state_county}&tid=DECENNIALDHC2020.P18.'
                ]),
            'primary_key' : 'huid',
            'pop_var' : 'numprec'},
        'incomegroup' : 
        {   'label' : 'Detailed Household Income Group',
            ...
            'notes' : '\n'.join([
                ...
                '5. To verify results compare table to: \n \n'
                f'https://data.census.gov/cedsci/table?g=0500000US{state_county}&tid=ACSDT5Y2012.B19001 \n \n'
                f'https://data.census.gov/cedsci/table?g=0500000US{state_county}&tid=ACSDT5Y2022.B19001'
                ]),
            'primary_key' : 'huid',
            'pop_var' : 'numprec'},
        'hhinc' : 
        ...
        {   'label' : 'Random Household Income',
            ...
            'notes' : '\n'.join([
                    ...
                    f'https://data.census.gov/cedsci/table?g=0500000US{state_county}&tid=ACSDT5Y2012.B19013 \n \n'
                    f'https://data.census.gov/cedsci/table?g=0500000US{state_county}&tid=ACSDT5Y2022.B19013 '
                    ])},
        'poverty' : 
            {   'label' : 'Poverty Status',
                ...
                'notes' : '\n'.join([
                    ...
                    '3. To verify results compare table to: \n \n'
                    f'https://data.census.gov/cedsci/table?g=0500000US{state_county}&tid=ACSDT5Y2012.B17021  \n \n'

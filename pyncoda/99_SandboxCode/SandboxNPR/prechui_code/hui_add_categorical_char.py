...
from pyincore_data_addons import globals
...
class add_new_char_by_random_merge_2dfs():
    ...
    def prepare_randommerge(randmerge_df, seed, 
        ...
        #  Sort by grouby vars and sort vars and Random Order
    ...
    def split_byHispanic(df):
        ...
        # start a new dictionary that will have Hispanic and Not Hispanic Datatframes
        df_split = {}
    ...
    def setup_run_random_merge_2dfs(self):
        ...
        print("After Recombime flag set",self.round-1,"=",flag_set_round.sum())  
